...
db.evaluation_templates.hasMany(db.evaluation_steps, {
  foreignKey: "evaluation_id",
  as: "evaluation_steps"
});

db.evaluation_types.hasMany(db.evaluation_templates, {
  foreignKey: "evaluation_type_id",
  as: "evaluation_templates"
});

db.evaluation_steps.belongsTo(db.evaluation_templates, {
  foreignKey: "evaluation_id",
  as: "evaluation_templates"
});

db.evaluation_templates.belongsTo(db.evaluation_types, {
  foreignKey: "evaluation_type_id",
  as: "evaluation_types"
});
